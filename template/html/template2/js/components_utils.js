const components_utils = {
  comp_file: {
    ...
    template: `
    <span>
      <input type="file" class="form-control" v-bind:id="id" v-bind:accept="accept" v-on:change="file_open" v-on:click="file_click" v-bind:multiple="multiple" v-on:input="do_input">
    </span>
    `,
    methods: {
